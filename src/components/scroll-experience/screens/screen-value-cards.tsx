  ...
  return (
    ...
    >
      <div className="w-full max-w-[1200px]">
        ...
        <h2
          className="mt-1.5 font-display text-4xl font-bold tracking-tight text-[var(--text-primary)] sm:text-5xl"
        >
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3" style={{ marginTop: 24 }}>
